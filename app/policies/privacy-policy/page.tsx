...
export const metadata: Metadata = {
  ...
  description:
    "Privacy policy for Stonebay Journal, including analytics, affiliate links, and data handling practices.",
  alternates: {
    canonical: "/policies/privacy-policy/",
  },
  openGraph: {
    title: "Privacy Policy — Stonebay Journal",
    description:
      "Privacy policy for Stonebay Journal, including analytics, affiliate links, and data handling practices.",
      ...
      <section className="border-t border-border py-10">
        <div className="editorial-prose flex flex-col gap-6">
          <p className="text-base leading-relaxed text-foreground">
            This Privacy Policy explains how Stonebay Journal ("we", "us", "our")
