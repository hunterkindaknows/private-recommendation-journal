...
export const metadata: Metadata = {
  ...
  description:
    "Solmere Journal is a premium editorial recommendation journal. One primary pick per page. We publish decisions, not lists.",
  alternates: {
    canonical: "/about/",
  },
}
      ...
      <section className="border-t border-border py-10">
        <div className="editorial-prose">
          <p className="text-base leading-relaxed text-foreground md:text-lg">
            Solmere Journal exists because shopping shouldn{"'"}t feel like
          ...
          <p className="mt-6 text-base leading-relaxed text-muted-foreground">
            ...
            one of our four editors{"—"}editors with distinct philosophies but
